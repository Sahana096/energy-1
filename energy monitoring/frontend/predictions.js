    ...
    new Chart(ctx, {
        ...
        data: {
            datasets: [{
                ...
                data: [
                    { x: 22, y: 18.5 }, { x: 24, y: 20.2 }, { x: 26, y: 22.8 },
                    { x: 28, y: 25.5 }, { x: 30, y: 28.9 }, { x: 32, y: 32.4 }, { x: 34, y: 35.8 }
                ],
        ...
        options: {
            ...
            scales: {
                y: {
                    beginAtZero: false,
                    title: { display: true, text: 'Consumption (kWh)', color: '#aaaaaa' },
                    grid: { color: 'rgba(255,255,255,0.1)' },
                    ticks: { color: '#aaaaaa' }
                },
                x: {
                    title: { display: true, text: 'Temperature (°C)', color: '#aaaaaa' },
                    grid: { color: 'rgba(255,255,255,0.1)' },
                    ticks: { color: '#aaaaaa' }
                }
            }
